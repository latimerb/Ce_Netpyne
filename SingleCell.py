...
netParams.popParams['LAf'] = {'cellModel' : 'VecStim', 'numCells': 2, 'cellsList': LAfList}
netParams.popParams['LAer'] = {'cellModel' : 'VecStim', 'numCells': 2, 'cellsList': LAerList}
netParams.popParams['BAf'] = {'cellModel' : 'VecStim', 'numCells': 2, 'cellsList': BAfList}
netParams.popParams['BAer'] = {'cellModel' : 'VecStim', 'numCells': 2, 'cellsList': BAerList}
...
netParams.connParams['LA->PKCdM'] = {'preConds': {'popLabel': ['LAf','LAer']}, 
	...
	'convergence': 2, 			# probability of connection
...
simConfig.analysis['plotTraces'] = {'include': all,'showFig':False} 			# Plot recorded traces for this list of cells
simConfig.analysis['plot2Dnet']  = {'saveData':True}         # plot 2D visualization of cell positions and connections
